            ...
            <div class="border-l border-gray-200 pl-3 md:pl-4 flex items-center space-x-2 md:space-x-3">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" @click.away="open = false"
                        ...
                        <a href="{{ route('admin.login') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-800">
                            <i class="fas fa-building mr-2"></i> As an Admin
                        </a>
                    </div>
                </div>
